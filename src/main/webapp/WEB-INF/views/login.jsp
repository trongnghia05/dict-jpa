...
<head>
	...
	<link href="<c:url value="/resources/images/icons/favicon.ic" />" rel="stylesheet">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				<form class="login100-form validate-form flex-sb flex-w" action ="trangchinh" method="POST">
